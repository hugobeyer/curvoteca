...
export function sdfSubtractCurve(
  ...
  return {
    ...
    snippets: {
      ...
      csharp: "float SdfSubtract(float x, float r1 = 0.3f, float c1 = 0.3f, float r2 = 0.3f, float c2 = 0.7f) { float d1 = MathF.Abs(x - c1) - r1; float d2 = MathF.Abs(x - c2) - r2; return MathF.Max(d1, -d2); }",
      ...
      python: "def sdf_subtract(x, r1=0.3, c1=0.3, r2=0.3, c2=0.7): d1 = abs(x - c1) - r1; d2 = abs(x - c2) - r2; return max(d1, -d2)",
      ...
      gdscript: "func sdfSubtract(x: float, r1: float = 0.3, c1: float = 0.3, r2: float = 0.3, c2: float = 0.7) -> float: var d1 = abs(x - c1) - r1; var d2 = abs(x - c2) - r2; return max(d1, -d2)",
