...
export function worleyF2F1Curve(
  ...
  return {
    ...
    snippets: {
      ...
      csharp:
        "float WorleyF2F1(float x, int seed = 1337, int cells = 6) { return 0; }",
      ...
      gdscript:
        "func worleyF2F1(x: float, seed: int = 1337, cells: int = 6) -> float: return 0.0",
      ...
      metal: "float worleyF2F1(float x, int seed, int cells) { return 0.0; }",
      opencl: "float worleyF2F1(float x, int seed, int cells) { return 0.0f; }",
      unity:
        "public static float WorleyF2F1(float x, int seed = 1337, int cells = 6) { return 0; }",
      shadertoy: "return 0.0;",
      matlab: "y = @(x, seed, cells) 0;",
    },
    kernel,
