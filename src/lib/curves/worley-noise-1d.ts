...
export function worleyNoise1dCurve(
  ...
  return {
    ...
    snippets: {
      ...
      csharp:
        "float WorleyNoise1d(float x, float seed = 1337, float cells = 6) { /* nearest feature point */ return Worley1dImpl(x, seed, cells); }",
      ...
      python:
        "def worley_noise_1d(x, seed=1337, cells=6): # nearest feature point; return worley_1d_impl(x, seed, cells)",
      ...
      gdscript:
        "func worleyNoise1d(x: float, seed: float = 1337.0, cells: float = 6.0) -> float: # nearest feature point; return worley1dImpl(x, seed, cells)",
      ...
      metal:
        "float worleyNoise1d(float x, float seed, float cells) { /* nearest feature point */ return worley1dImpl(x, seed, cells); }",
      opencl:
        "float worleyNoise1d(float x, float seed, float cells) { /* nearest feature point */ return worley1dImpl(x, seed, cells); }",
      unity:
        "public static float WorleyNoise1d(float x, float seed = 1337, float cells = 6) { return Worley1dImpl(x, seed, cells); }",
      shadertoy: "return worley1dImpl(x, seed, cells);",
      matlab: "y = @(x, seed, cells) worley1dImpl(x, seed, cells);",
    },
    kernel,
