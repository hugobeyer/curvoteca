import { DEFAULT_SAMPLING, quadraticOutKernel, type CurveKernel } from "../curveMath";
...
export function quadraticOutCurve(
  ...
  return {
    ...
    snippets: {
      ...
      csharp: "float QuadraticOut(float x) { float u = 1.0f - x; return 1.0f - u * u; }",
      ...
      gdscript: "func quadraticOut(x: float) -> float: var u = 1 - x; return 1 - u * u",
