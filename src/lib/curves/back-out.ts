...
export function backOutCurve(
  ...
  return {
    ...
    snippets: {
      ...
      csharp: "float BackOut(float x, float s = 1.70158f) { float u = 1 - x; return 1 - u * u * ((s + 1) * u - s); }",
      ...
      python: "def back_out(x, s=1.70158): u = 1 - x; return 1 - u * u * ((s + 1) * u - s)",
      ...
      gdscript: "func backOut(x: float, s: float = 1.70158) -> float: var u = 1 - x; return 1 - u * u * ((s + 1) * u - s)",
