...
export function windowHammingCurve(
  ...
  return {
    ...
    snippets: {
      ...
      csharp:
        "float WindowHamming(float x) { return 0.54f - 0.46f * MathF.Cos(2.0f * MathF.PI * x); }",
      ...
      python:
        "def windowHamming(x): return 0.54 - 0.46 * math.cos(2 * math.pi * x)",
      ...
      gdscript:
        "func windowHamming(x: float) -> float: return 0.54 - 0.46 * cos(2.0 * PI * x)",
      ...
      metal:
        "float windowHamming(float x) { return 0.54 - 0.46 * cos(2.0 * 3.14159265 * x); }",
      opencl:
        "float windowHamming(float x) { return 0.54f - 0.46f * cosf(2.0f * 3.14159265f * x); }",
      unity:
        "public static float WindowHamming(float x) { return 0.54f - 0.46f * Mathf.Cos(2.0f * Mathf.PI * x); }",
      matlab: "y = @(x) 0.54 - 0.46 * cos(2 * pi * x);",
    },
    kernel,
