import { DEFAULT_SAMPLING, sineOutKernel, type CurveKernel } from "../curveMath";
...
export function sineOutCurve(
  ...
  return {
    ...
    snippets: {
      ...
      csharp: "float SineOut(float x) { return MathF.Sin((1.0f - x) * 1.57079633f); }",
      ...
      gdscript: "func sineOut(x: float) -> float: return sin((1.0 - x) * PI / 2.0)",
